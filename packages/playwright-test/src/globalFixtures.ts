...
import { WorkerInfo, TestError, FullProjectInternal, FullConfigInternal } from './types';
...
export class GlobalFixtureRunner {
  ...
  async setupGlobalFixtures(): Promise<GlobalFixtureValues> {
...
const dummyProject: FullProjectInternal = {
  expect: {},
  outputDir: '',
  repeatEach: 1,
  retries: 0,
