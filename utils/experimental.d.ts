...
export interface BrowserType {
   ...
   * @param options
   */
  connect(wsEndpoint: string, options?: BrowserTypeConnectOptions): Promise<Browser>;
   ...
   * @param options
   */
  connectOverCDP(endpointURL: string, options?: BrowserTypeConnectOverCDPOptions): Promise<Browser>;
...
export interface ElectronApplication {
   ...
   */
  evaluate(pageFunction: Function|Electron, arg?: EvaluationArgument): Promise<Serializable>;
   ...
   * @param arg
   */
  evaluateHandle(pageFunction: Function|Electron, arg: EvaluationArgument): Promise<JSHandle>;
...
export interface ElementHandle extends JSHandle {
   ...
   * @param arg Optional argument to pass to `pageFunction`.
   */
  $eval(selector: string, pageFunction: ((element: Element) => void), arg?: EvaluationArgument): Promise<Serializable>;
   ...
   * @param arg Optional argument to pass to `pageFunction`.
   */
  $$eval(selector: string, pageFunction: ((array: Array<Element>) => void), arg?: EvaluationArgument): Promise<Serializable>;
...
export interface Frame {
   ...
   * @param options
   */
  $eval(selector: string, pageFunction: ((element: Element) => void), arg?: EvaluationArgument, options?: {
    /**
     * When true, the call requires selector to resolve to a single element. If given selector resolves to more then one
     * element, the call throws an exception.
     */
   ...
   * @param arg Optional argument to pass to `pageFunction`.
   */
  evaluate(pageFunction: Function|string, arg?: EvaluationArgument): Promise<Serializable>;
   ...
   * @param arg Optional argument to pass to `pageFunction`.
   */
  evaluateHandle(pageFunction: Function|string, arg?: EvaluationArgument): Promise<JSHandle>;
...
export interface JSHandle {
   ...
   */
  jsonValue(): Promise<Serializable>;
}
...
export interface Locator {
   ...
   * @param options
   */
  evaluate(pageFunction: Function|string, arg?: EvaluationArgument, options?: {
    /**
     * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by
     * using the
     * [browserContext.setDefaultTimeout(timeout)](https://playwright.dev/docs/api/class-browsercontext#browser-context-set-default-timeout)
   ...
   * @param arg Optional argument to pass to `pageFunction`.
   */
  evaluateAll(pageFunction: Function|string, arg?: EvaluationArgument): Promise<Serializable>;
...
export interface Fixtures {
  ...
  /**
   * Name of the browser that runs tests. Defaults to `'chromium'`. Useful to [annotate tests](https://playwright.dev/docs/test-annotations) based
   * on the browser.
   *
   * ```ts
...
export interface Test {
   ...
   */
  (call)(title: string, testFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   */
  afterAll(hookFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   */
  afterEach(hookFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   * @param hookFunction Hook function that takes one or two arguments: an object with worker fixtures and optional [TestInfo].
   */
  beforeAll(hookFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   * @param hookFunction Hook function that takes one or two arguments: an object with fixtures and optional [TestInfo].
   */
  beforeEach(hookFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   */
  describe.only(title: string, callback: Function): void;
   ...
   */
  describe.parallel(title: string, callback: Function): void;
   ...
   */
  describe.parallel.only(title: string, callback: Function): void;
   ...
   * added in this callback will belong to the group.
   */
  describe.serial(title: string, callback: Function): void;
   ...
   */
  describe.serial.only(title: string, callback: Function): void;
   ...
   */
  describe.skip(title: string, callback: Function): void;
   ...
   */
  fail(condition?: void|boolean|((fixtures: Fixtures) => boolean), description?: void|string): void;
   ...
   * @param testFunction Test function that takes one or two arguments: an object with fixtures and optional [TestInfo].
   */
  fixme(title: string, testFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   */
  fixme(condition: boolean, description: void|string): void;
   ...
   * @param description An optional description that will be reflected in a test report.
   */
  fixme(callback: ((fixtures: Fixtures) => boolean), description: void|string): void;
   ...
   * @param testFunction Test function that takes one or two arguments: an object with fixtures and optional [TestInfo].
   */
  only(title: string, testFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   * @param testFunction Test function that takes one or two arguments: an object with fixtures and optional [TestInfo].
   */
  skip(title: string, testFunction: ((fixtures: Fixtures, testinfo: TestInfo) => void)): void;
   ...
   * @param description An optional description that will be reflected in a test report.
   */
  skip(condition: boolean, description: void|string): void;
   ...
   * @param description An optional description that will be reflected in a test report.
   */
  skip(callback: ((fixtures: Fixtures) => boolean), description: void|string): void;
   ...
   * @param description Optional description that will be reflected in a test report.
   */
  slow(condition?: void|boolean|((fixtures: Fixtures) => boolean), description?: void|string): void;
   ...
   */
  step(title: string, body: ((: ) => Promise<any>)): void;
...
export interface TestConfig {
  ...
  expect: {
    ...
    toHaveScreenshot: {
      ...
      /**
       * See `size` in [page.screenshot([options])](https://playwright.dev/docs/api/class-page#page-screenshot). Defaults to
       * `"css"`.
       */
      size?: "css"|"device";
    };
   ...
   *
   */
  testIgnore: string|RegExp|Array<string>|Array<RegExp>;
   ...
   *
   */
  testMatch: string|RegExp|Array<string>|Array<RegExp>;
  ...
  webServer: {
    ...
    /**
     * Port to wait on for the web server (exactly one of `port` or `url` is required)
     */
    port: number;

    /**
     * URL to wait on for the web server (exactly one of `port` or `url` is required)
     */
    url: string;
    ...
    /**
     * Maximum duration to wait on until the web server is ready
     */
    timeout: number;

    /**
     * If true, reuse the existing server if it is already running, otherwise it will fail
     */
...
export interface TestInfo {
   ...
   * @param description Optional description that will be reflected in a test report.
   */
  fail(condition?: void|boolean, description?: void|string): void;
   ...
   * @param description Optional description that will be reflected in a test report.
   */
  fixme(condition?: void|boolean, description?: void|string): void;

  /**
   * Test function as passed to `test(title, testFunction)`.
   */
  fn: ((testargs: TestArgs, testinfo: TestInfo) => void);
   ...
   * @param description Optional description that will be reflected in a test report.
   */
  skip(condition?: void|boolean, description?: void|string): void;
   ...
   * @param description Optional description that will be reflected in a test report.
   */
  slow(condition?: void|boolean, description?: void|string): void;
   ...
   *
   */
  status: void|"passed"|"failed"|"timedOut"|"skipped";
...
export interface TestOptions {
  ...
  connectOptions: void|{
     ...
     */
    headers?: void|{ [key: string]: string; };
  ...
  trace: {
    ...
    /**
     * Whether to capture screenshots during tracing. Screenshots are used to build a timeline preview. Defaults to true.
     * Optional.
     */
    screenshots?: boolean;
...
export interface Reporter {
   ...
   */
  onBegin(config: TestConfig, suite: Suite): void;
...
export interface BrowserTypeLaunchOptions {
  /**
   * Additional arguments to pass to the browser instance. The list of Chromium flags can be found
   * [here](http://peter.sh/experiments/chromium-command-line-switches/).
   */
...
export interface BrowserTypeConnectOverCDPOptions {
  /**
...
export interface BrowserTypeConnectOptions {
  /**
   * Additional HTTP headers to be sent with web socket connect request. Optional.
   */
  headers?: { [key: string]: string; };
...
export interface BrowserContextCookies {
  name: string;
...
export interface BrowserNewContextOptions {
  /**
   * Whether to automatically download all the attachments. Defaults to `true` where all the downloads are accepted.
   */
  acceptDownloads?: boolean;
...
export interface BrowserNewContextOptionsViewport {
  /**
   * page width in pixels.
   */
  width: number;
...
export interface BrowserNewContextOptionsHttpCredentials {
  username: string;

  password: string;
}

export interface BrowserNewContextOptionsGeolocation {
  /**
   * Latitude between -90 and 90.
   */
  latitude: number;
